...
function watch(obj, name) {
    return new Proxy(obj, {
      get: function(target, property, receiver) {
        try {
          if (typeof target[property] === "function") {
            console.table([{"方法 =>" : name + ".调用方法." + property + ".返回:" + "function" + ".类型为:" + (typeof target[property])}])
          } else {
            console.table([{"方法 =>" : name + ".读取属性." + property + ".返回:" + target[property] + ".类型为:" + (typeof target[property])}])
          }
        } catch (e) {
        }
      ...
      set: function(target, property, newValue, receiver) {
        try {
          console.table([{"方法 =>" : name + ".设置属性." + property + ".为:" + newValue + ".类型为:" + (typeof newValue)}])
        } catch (e) {
        }
...
arg = '{"comm":{"cv":4747474,"ct":24,"format":"json","inCharset":"utf-8","outCharset":"utf-8","notice":0,"platform":"yqq.json","needNewCode":1,"uin":0,"g_tk_new_20200303":5381,"g_tk":5381},"req_1":{"module":"music.musicsearch.HotkeyService","method":"GetHotkeyForQQMusicMobile","param":{"searchid":"21912871676952963","remoteplace":"txt.yqq.top","from":"yqqweb"}},"req_2":{"module":"music.mvRanking.VideoRank","method":"get_video_rank_list","param":{"rank_type":0,"area_type":0,"required":["vid","name","pubdate","cover_pic","singers","trend"]}},"req_3":{"module":"music.mvRanking.VideoRank","method":"get_history_key_list","param":{"periods":6}},"req_4":{"module":"MvService.MvInfoProServer","method":"GetToplistTag","param":{}},"req_5":{"module":"music.paycenterapi.LoginStateVerificationApi","method":"GetChargeAccount","param":{"appid":"mlive"}}}'
